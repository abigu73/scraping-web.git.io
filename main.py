...
def scraping_data():
    url = 'https: http:/www.voanews.com/'
...
def main():
    BOT_TOKEN = '6363494971:AAHfGd4rJqWTnPGqf4PhnNEUkFwoc1rIOxc'
    BOT_CHAT_ID = '1602509372'
    def send_to_telegram(bot_token, chat_id, text):
     url = f"https://t.me/aywlm_bot{bot_token}/sendMessage"
